...
function signUp(){
    ...
    if(checkUserFullNameValid == null){
        ...
        firebase.auth().createUserWithEmailAndPassword(userEmail, userPassword).then((success) => {
            ...
            var firebaseRef = firebase.database().ref("grace-daniel");
            var userData = {
...
firebase.auth().onAuthStateChanged((user)=>{
    ...
    //   User is signed in.
        ...
        let firebaseRefKey = firebase.database().ref("grace-daniel").child(uid);
...
function showEditProfileForm(){
    ...
    var userPfFullName = document.getElementById("userPfFullName").value;
    var userPfSurname = document.getElementById("userPfSurname").value;
    ...
    document.getElementsByClassName("userFullName").innerHTML = userPfFullName; 
    document.getElementsByClassName("userSurname").innerHTML = userPfSurname; 
    document.getElementsByClassName("userFacebook").innerHTML = userPfFb;
    document.getElementsByClassName("userTwitter").innerHTML = userPfTw; 
    document.getElementsByClassName("userGooglePlus").innerHTML = userPfGp; 
    document.getElementsByClassName("userBio").innerHTML = userPfBio; 
}
